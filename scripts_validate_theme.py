...
def check(where, settings, defs):
    ...
    for k,v in settings.items():
        ...
        elif isinstance(v,str) and '{{' in v and t!='liquid' and k!='custom_liquid': warn(f'{where}: {k} contains Liquid braces — JSON template settings are not rendered as Liquid')
