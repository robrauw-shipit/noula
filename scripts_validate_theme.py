...
sd=json.load(open('config/settings_data.json')); schemes=set(sd['current'].get('color_schemes',{}))
...
sch=json.load(open('config/settings_schema.json')); gl=[st for g in sch for st in g.get('settings',[])]
